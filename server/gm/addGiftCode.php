...
addHeader(array('User', 'Add Gift Code'));
...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="addGiftCode.php" id="fRequest" method="POST" lass="form-horizontal">
                ...
                <div class="row form-group">
                    <div class="col col-md-2"><label for="text-input" class=" form-control-label">Users</label></div>
                    <div class="col-12 col-md-4">
                        <input type="text" name="users" <?php addPostValue('users');?> placeholder="List user id" class="form-control">
                    </div>
                    <div class="col-12 col-md-4"><small class="form-text text-muted">id1,id2,id3</small></div>
                </div>               
				<div class="row form-group">
...
if (isset($_POST['group'])) {
	...
	$result = sendAdminRequest('addGiftCode', $data);
	if (isset($result)) {
?>
	<script>
