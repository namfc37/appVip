...
if(isset($_POST['userId'])) {
    $userId = $_POST['userId'];
    addHeader(array('User', 'Ban User', $userId));
} else {	
    addHeader(array('User', 'Ban User'));
}
?>
...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="banUser.php" id="fRequest" method="POST" lass="form-horizontal">
                ...
                <div class="row form-group">
                    <div class="col col-md-2"><label for="text-input" class=" form-control-label">Duration</label></div>
                    <div class="col-12 col-md-4">
                        <input type="text" name="duration" <?php addPostValue('duration');?> placeholder="Duration" class="form-control">
                    </div>
                </div>                
                <div class="row form-group">
...
if (isset($userId)) {
	...
	$result = sendAdminRequest('banUser', $data);
	if (isset($result)) {
?>
	<script>
