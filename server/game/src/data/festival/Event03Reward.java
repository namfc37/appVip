...
public class Event03Reward
{
    ...
    public void test ()
    {
        ...
        Debug.info("Event03Info", "num", num, items.size(), Json.toJson(ids));
        ...
        for (int i = 0; i < testCount; i++)
        {
            ...
            {
                Debug.info("Event03Info", "wrong", num, MetricLog.toString(test));
                test = generate();
                System.exit(0);
            }
        ...
        for (Reward r : items)
        {
            ...
            Debug.info("Event03Info", r.id, r.quantity, r.rate, itemTotal, count, rate);
        }
    }
