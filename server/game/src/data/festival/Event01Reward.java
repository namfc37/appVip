...
public class Event01Reward
{
    ...
    public void test ()
    {
        ...
        Debug.info("Event01Info", "num", num, items.size(), Json.toJson(ids));
        ...
        for (int i = 0; i < testCount; i++)
        {
            ...
            {
                Debug.info("Event01Info", "wrong", num, MetricLog.toString(test));
                test = generate();
                System.exit(0);
            }
        ...
        for (Reward r : items)
        {
            ...
            Debug.info("Event01Info", r.id, r.quantity, r.rate, itemTotal, count, rate);
        }
    }
