...
class Billing
{
    ...
    static function promo($uId,$username = 'toannobi',$nMoney = 1,$campain = 1,$admin = 'zp')
    {
    ...
    static function addCash($uId,$username = 'toannobi',$nMoney = 1,$campain = 102,$CashType = 'Promo', $RealCashAmt = 1, $cashCode ='' ,$admin = 'HungVM2')
    {
