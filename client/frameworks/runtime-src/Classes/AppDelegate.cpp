...
{
	FileUtils::setEncryptKeyPart(0, 0x11111111);
	FileUtils::setEncryptKeyPart(1, 0x11111111);
	FileUtils::setEncryptKeyPart(2, 0x11111111);
	FileUtils::setEncryptKeyPart(3, 0x11111111);
}
...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	fr::FrameworkDelegate::getInstance()->setFolderAssets("kvtm");
    // initialize director
